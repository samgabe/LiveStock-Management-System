...
<body>
    ...
    <?php if (isset($_SESSION['username'])):   ?>
        ...
        <p style="float: right; padding-right: 12px;"><a href="index.php?logout='1'" style="color: red;">Logout</a></p>
    <?php endif ?>
      </ul>
  </div>
  <div class="container">
 ...
 <!-- style="color:red;font-size:30px; padding-left:30px;padding-top:30px;"--> 
			<div > 
				<label> <b>View livestock records</b></label> 
		...
		<div id="head">
			<div id="list">
				<ul>
					...
					<li class="active"><a href="view1.php">Livestock</a></li>
					<li><a href="view2.php">Pasture</a></li>
					<li><a href="view3.php">Health</a></li>
