...
<body>
 ...
 <!-- style="color:red;font-size:30px; padding-left:30px;padding-top:30px;"--> 
       ...
       <a href="health.php" style="float: right;margin-right: 20px;padding-top: 20px; ">&nbsp; Or &nbsp; Cancel</a> <button onclick="window.location.href='health.php'"type="submit" style="float: right;margin-right: 10px;" class="btn3">Create Health</button>
